...
CREATE TABLE IF NOT EXISTS Shipments_has_Rocks (
  ...
  rockID INT NOT NULL,
  PRIMARY KEY (shipmentID, rockID),
  INDEX `fk_Shipments_has_Rocks_Rocks1_idx` (`rockID` ASC) VISIBLE,
  INDEX `fk_Shipments_has_Rocks_Shipments1_idx` (`shipmentID` ASC) VISIBLE,
